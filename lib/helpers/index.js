...
exports.getFiles = function(options) {
    ...
    exports.asyncForEach(includes, function(glob){
        return exports.glob(glob, {}).then(function(files) {
            files.forEach(function(file){ allFiles.push(file); });
        });
    }).then(function(){
            return exports.asyncForEach(excludes, function(glob){
                return exports.glob(glob, {}).then(function(files) {
            ...
            if(options.files){
                options.files.forEach(function(item){ allFiles.push(item); });
            }

            var filteredFiles = exports.distinct(allFiles);
            dfd.resolve(filteredFiles);
        });
